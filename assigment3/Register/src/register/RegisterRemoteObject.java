...
/**
 * Generic functionality to register remote objects in the local registry
 * service.
 *
...
public class RegisterRemoteObject implements Register {
    /**
     * Name of the local host (where the registering service is supposed to be
     * located).
     */
    ...
    /**
     * Instantiation of a registering object (where the registering service is
